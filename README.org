...
Ensure the directory name is on a single line to simplify cut and paste.

All code examples should induced a suggested filename to save to the directory.

Suggest questions the student should be able to answer at the end of the course. 
#+end_quote
...
** TODO Cohort: Software-Oriented Acceleration for You, Me, and Our Heterogeneous SoCs
